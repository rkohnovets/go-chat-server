...
type ChatV1Client interface {
	Create(ctx context.Context, in *ChatCreateRequest, opts ...grpc.CallOption) (*IdResponse, error)
...
func (c *chatV1Client) Create(ctx context.Context, in *ChatCreateRequest, opts ...grpc.CallOption) (*IdResponse, error) {
...
func (c *chatV1Client) Delete(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ChatV1Server interface {
	Create(context.Context, *ChatCreateRequest) (*IdResponse, error)
...
func (UnimplementedChatV1Server) Create(context.Context, *ChatCreateRequest) (*IdResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedChatV1Server) Delete(context.Context, *IdRequest) (*emptypb.Empty, error) {
...
func _ChatV1_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatV1Server).Delete(ctx, req.(*IdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ChatV1_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/chat_v1/chat.proto",
}
